...
DEFAULT_PHRASES = {
    ...
    "nudge_view_tasks": [
        "Мм, у тебя пока нет задач с шагами... Загляни в задачи — создай первую, я помогу~ 📂",
        "Пусто в задачах, м... Добавь что-нибудь, а я подскажу шаги~ 💋",
    ],
    # === ЧАСТЬ C: азарт-слой ===
    "drop_common": [
...
EVENT_LABELS = [
    ...
    ("nudge_view_tasks", "📂 Побуждение к задачам (нет кандидата)"),
